			...
			<div className='container mx-auto px-6'>
				<motion.div className='max-w-3xl mx-auto text-center' {...fadeInUp}>
					...
					<p className='text-gray-300 text-lg leading-relaxed mb-8'>
						Depuis plus de 25 ans, je vis et partage ma passion pour les danses
						urbaines. Que tu sois débutant ou danseur confirmé, je t'offre un
						espace bienveillant pour progresser à ton rythme et exprimer ta
						créativité.
					</p>
