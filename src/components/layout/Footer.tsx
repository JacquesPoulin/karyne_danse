				...
				<div className='grid md:grid-cols-3 gap-8'>
					...
					<div>
						...
						<ul className='space-y-2'>
							...
							<li>
								<Link href='/biographie' className='hover:text-purple-600'>
									Biographie
								</Link>
							</li>
							<li>
								<Link href='/cours-workshops' className='hover:text-purple-600'>
									Cours & Workshops
								</Link>
							</li>
							<li>
								<Link href='/galerie' className='hover:text-purple-600'>
									Galerie
								</Link>
							</li>
							<li>
					...
					<div>
						...
						<p className='mb-2'>123 Rue de la Danse</p>
						<p className='mb-2'>75000 Paris</p>
						<p className='mb-2'>01 23 45 67 89</p>
						<p>contact@karyndanse.fr</p>
					</div>
				</div>
